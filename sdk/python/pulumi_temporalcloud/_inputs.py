...
if not MYPY:
    class NamespaceExportSinkGcsArgsDict(TypedDict):
        ...
        """
        gcp_project_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NamespaceExportSinkGcsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] gcp_project_id: The GCP project ID associated with the GCS bucket and service account. If not provided, the service*account*email must be provided.
        :param pulumi.Input[builtins.str] service_account_email: The service account email associated with the GCS bucket and service account. If not provided, the service*account*id and gcp*project*id must be provided.
        :param pulumi.Input[builtins.str] service_account_id: The customer service account ID that Temporal Cloud impersonates for writing records to the customer's GCS bucket. If not provided, the service*account*email must be provided.
        """

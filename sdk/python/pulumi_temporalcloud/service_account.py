...
class ServiceAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] account_access: The role on the account. Must be one of admin, developer, or read (case-insensitive).
        :param pulumi.Input[_builtins.str] description: The description for the service account.
        :param pulumi.Input[_builtins.str] name: The name associated with the service account.
...
class _ServiceAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: The name associated with the service account.
        :param pulumi.Input[Sequence[pulumi.Input['ServiceAccountNamespaceAccessArgs']]] namespace_accesses: The set of namespace accesses. Empty sets are not allowed, omit the attribute instead. Service Accounts with an account*access role of admin cannot be assigned explicit permissions to namespaces. Admins implicitly receive access to all Namespaces.
        :param pulumi.Input[_builtins.str] state: The current state of the Service Account.
        """
...
@pulumi.type_token("temporalcloud:index/serviceAccount:ServiceAccount")

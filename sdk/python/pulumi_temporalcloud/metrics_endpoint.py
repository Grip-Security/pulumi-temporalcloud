...
class MetricsEndpointArgs:
    def __init__(__self__, *,
                 accepted_client_ca: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] accepted_client_ca: The Base64-encoded CA cert in PEM format used to authenticate clients connecting to the metrics endpoint.
        """
    ...
    def accepted_client_ca(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def accepted_client_ca(self, value: pulumi.Input[_builtins.str]):
...
class _MetricsEndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] accepted_client_ca: The Base64-encoded CA cert in PEM format used to authenticate clients connecting to the metrics endpoint.
        :param pulumi.Input[_builtins.str] uri: The Prometheus metrics endpoint URI
        """
...
class MetricsEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            accepted_client_ca: Optional[pulumi.Input[_builtins.str]] = None,
            timeouts: Optional[pulumi.Input[Union['MetricsEndpointTimeoutsArgs', 'MetricsEndpointTimeoutsArgsDict']]] = None,
            uri: Optional[pulumi.Input[_builtins.str]] = None) -> 'MetricsEndpoint':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="acceptedClientCa")
    def accepted_client_ca(self) -> pulumi.Output[_builtins.str]:
        """
        The Base64-encoded CA cert in PEM format used to authenticate clients connecting to the metrics endpoint.
        """
        return pulumi.get(self, "accepted_client_ca")

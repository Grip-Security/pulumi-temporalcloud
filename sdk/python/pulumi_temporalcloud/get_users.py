...
def get_users(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetUsersResult:
    ...
    __ret__ = pulumi.runtime.invoke('temporalcloud:index/getUsers:getUsers', __args__, opts=opts, typ=GetUsersResult).value
...
def get_users_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetUsersResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('temporalcloud:index/getUsers:getUsers', __args__, opts=opts, typ=GetUsersResult)

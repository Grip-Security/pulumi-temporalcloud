...
class NamespaceExportSinkArgs:
    def __init__(__self__, *,
                 ...
                 sink_name: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] namespace: The namespace under which the sink is configured. It's needed to be in the format of \\n\\n.\\n\\n
        :param pulumi.Input[_builtins.str] sink_name: The unique name of the export sink, it can't be changed once set.
        :param pulumi.Input[_builtins.bool] enabled: A flag indicating whether the export sink is enabled or not.
    ...
    def sink_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @sink_name.setter
    def sink_name(self, value: pulumi.Input[_builtins.str]):
...
class _NamespaceExportSinkState:
    def __init__(__self__, *,
                 ...
                 s3: Optional[pulumi.Input['NamespaceExportSinkS3Args']] = None,
                 sink_name: Optional[pulumi.Input[_builtins.str]] = None,
                 timeouts: Optional[pulumi.Input['NamespaceExportSinkTimeoutsArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="sinkName")
    def sink_name(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The unique name of the export sink, it can't be changed once set.
        """
        return pulumi.get(self, "sink_name")
    ...
    @sink_name.setter
    def sink_name(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "sink_name", value)
...
class NamespaceExportSink(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="sinkName")
    def sink_name(self) -> pulumi.Output[_builtins.str]:
        """
        The unique name of the export sink, it can't be changed once set.
        """
        return pulumi.get(self, "sink_name")

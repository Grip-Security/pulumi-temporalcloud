...
class NamespaceExportSinkGcs(dict):
    ...
    def __init__(__self__, *,
                 ...
                 region: builtins.str,
                 gcp_project_id: Optional[builtins.str] = None,
        ...
        :param builtins.str gcp_project_id: The GCP project ID associated with the GCS bucket and service account. If not provided, the service*account*email must be provided.
        :param builtins.str service_account_email: The service account email associated with the GCS bucket and service account. If not provided, the service*account*id and gcp*project*id must be provided.
        :param builtins.str service_account_id: The customer service account ID that Temporal Cloud impersonates for writing records to the customer's GCS bucket. If not provided, the service*account*email must be provided.
        """
    ...
    def gcp_project_id(self) -> Optional[builtins.str]:
        """
...
class GetNexusEndpointWorkerTargetResult(dict):
    def __init__(__self__, *,
                 ...
                 task_queue: builtins.str):
        """
        :param builtins.str namespace_id: The target cloud namespace to route requests to. Namespace is in same account as the endpoint.
        :param builtins.str task_queue: The task queue on the cloud namespace to route requests to.
        """
        pulumi.set(__self__, "namespace_id", namespace_id)
        pulumi.set(__self__, "task_queue", task_queue)
...
class GetNexusEndpointsNexusEndpointResult(dict):
    def __init__(__self__, *,
                 allowed_caller_namespaces: Sequence[builtins.str],
        ...
        """
        :param Sequence[builtins.str] allowed_caller_namespaces: Namespace Id(s) that are allowed to call this Endpoint.
        :param builtins.str created_at: The creation time of the Nexus Endpoint.
        :param builtins.str description: The description of the Nexus Endpoint.
        :param builtins.str id: The unique identifier of the Nexus Endpoint.
        :param builtins.str name: The name of the endpoint. Unique within an account and match `^[a-zA-Z][a-zA-Z0-9\\-]*[a-zA-Z0-9]$`
        :param builtins.str state: The current state of the Nexus Endpoint.
        :param builtins.str updated_at: The last update time of the Nexus Endpoint.
    ...
    def allowed_caller_namespaces(self) -> Sequence[builtins.str]:
        """
...
class GetUsersUserResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str account_access: The role on the account. Must be one of admin, developer, or read (case-insensitive).
        :param builtins.str created_at: The creation time of the User.
        ...
        :param builtins.str state: The current state of the User.
        :param builtins.str updated_at: The last update time of the User.
        """
        pulumi.set(__self__, "account_access", account_access)
        pulumi.set(__self__, "created_at", created_at)

...
class NamespaceSearchAttributeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] namespace_id: The ID of the namespace to which this search attribute belongs.
        :param pulumi.Input[_builtins.str] type: The type of the search attribute. Must be one of `bool`, `datetime`, `double`, `int`, `keyword`, `keyword_list` or `text`. (case-insensitive)
        :param pulumi.Input[_builtins.str] name: The name of the search attribute.
        """
...
class NamespaceSearchAttribute(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[_builtins.str]] = None,
            namespace_id: Optional[pulumi.Input[_builtins.str]] = None,
            type: Optional[pulumi.Input[_builtins.str]] = None) -> 'NamespaceSearchAttribute':
        """

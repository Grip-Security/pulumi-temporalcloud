...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 allowed_account_id: Optional[pulumi.Input[_builtins.str]] = None,
                 api_key: Optional[pulumi.Input[_builtins.str]] = None,
                 endpoint: Optional[pulumi.Input[_builtins.str]] = None):
        """
        The set of arguments for constructing a Provider resource.
        :param pulumi.Input[_builtins.bool] allow_insecure: If set to True, it allows for an insecure connection to the Temporal Cloud API. This should never be set to 'true' in
               production and defaults to false.
        :param pulumi.Input[_builtins.str] allowed_account_id: The ID of the account to operate on. Prevents accidental mutation of accounts other than that provided.
        :param pulumi.Input[_builtins.str] api_key: The API key for Temporal Cloud. See [this documentation](https://docs.temporal.io/cloud/api-keys) for information on how
               to obtain an API key.
        :param pulumi.Input[_builtins.str] endpoint: The endpoint for the Temporal Cloud API. Defaults to `saas-api.tmprl.cloud:443`.
        """
    ...
    def allowed_account_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def allowed_account_id(self, value: Optional[pulumi.Input[_builtins.str]]):
...
@pulumi.type_token("pulumi:providers:temporalcloud")
class Provider(pulumi.ProviderResource):
    ...
    @_builtins.property
    @pulumi.getter(name="allowedAccountId")
    def allowed_account_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        The ID of the account to operate on. Prevents accidental mutation of accounts other than that provided.
        """
        return pulumi.get(self, "allowed_account_id")
    ...
    def terraform_config(__self__) -> pulumi.Output['Provider.TerraformConfigResult']:
        ...
        return pulumi.runtime.call('pulumi:providers:temporalcloud/terraformConfig', __args__, res=__self__, typ=Provider.TerraformConfigResult)

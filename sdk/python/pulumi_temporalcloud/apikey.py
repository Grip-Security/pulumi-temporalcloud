...
class ApikeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: The display name for the API key.
        :param pulumi.Input[_builtins.str] expiry_time: The expiry time for the API key in ISO 8601 format.
        :param pulumi.Input[_builtins.str] owner_id: The ID of the owner to create the API key for.
        :param pulumi.Input[_builtins.str] owner_type: The type of the owner to create the API key.
        :param pulumi.Input[_builtins.str] description: The description for the API key.
        :param pulumi.Input[_builtins.bool] disabled: Whether the API key is disabled.
        """
...
class _ApikeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] owner_id: The ID of the owner to create the API key for.
        :param pulumi.Input[_builtins.str] owner_type: The type of the owner to create the API key.
        :param pulumi.Input[_builtins.str] state: The current state of the API key.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
        if disabled is not None:

...
export class ConnectivityRule extends pulumi.CustomResource {
    ...
    public readonly timeouts!: pulumi.Output<outputs.ConnectivityRuleTimeouts | undefined>;
    ...
    constructor(name: string, argsOrState?: ConnectivityRuleArgs | ConnectivityRuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.connectivityType === undefined) && !opts.urn) {
...
export interface ConnectivityRuleState {
    ...
    timeouts?: pulumi.Input<inputs.ConnectivityRuleTimeouts>;
}

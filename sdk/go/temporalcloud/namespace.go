...
type Namespace struct {
	...
	ConnectivityRuleIds pulumi.StringArrayOutput `pulumi:"connectivityRuleIds"`
...
type NamespaceState struct {
	...
	// The IDs of the connectivity rules for this namespace.
	ConnectivityRuleIds pulumi.StringArrayInput
	// The endpoints for the namespace.
...
// The IDs of the connectivity rules for this namespace.
func (o NamespaceOutput) ConnectivityRuleIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v *Namespace) pulumi.StringArrayOutput { return v.ConnectivityRuleIds }).(pulumi.StringArrayOutput)
}

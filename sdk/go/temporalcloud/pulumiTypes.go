...
type ConnectivityRuleTimeouts struct {
	// A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
	Create *string `pulumi:"create"`
	// A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
	Delete *string `pulumi:"delete"`
...
// ConnectivityRuleTimeoutsInput is an input type that accepts ConnectivityRuleTimeoutsArgs and ConnectivityRuleTimeoutsOutput values.
// You can construct a concrete instance of `ConnectivityRuleTimeoutsInput` via:
//
//	ConnectivityRuleTimeoutsArgs{...}
type ConnectivityRuleTimeoutsInput interface {
	pulumi.Input

	ToConnectivityRuleTimeoutsOutput() ConnectivityRuleTimeoutsOutput
	ToConnectivityRuleTimeoutsOutputWithContext(context.Context) ConnectivityRuleTimeoutsOutput
}

type ConnectivityRuleTimeoutsArgs struct {
	// A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
	Create pulumi.StringPtrInput `pulumi:"create"`
	// A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
	Delete pulumi.StringPtrInput `pulumi:"delete"`
...
func (ConnectivityRuleTimeoutsArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*ConnectivityRuleTimeouts)(nil)).Elem()
}

func (i ConnectivityRuleTimeoutsArgs) ToConnectivityRuleTimeoutsOutput() ConnectivityRuleTimeoutsOutput {
	return i.ToConnectivityRuleTimeoutsOutputWithContext(context.Background())
}

func (i ConnectivityRuleTimeoutsArgs) ToConnectivityRuleTimeoutsOutputWithContext(ctx context.Context) ConnectivityRuleTimeoutsOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ConnectivityRuleTimeoutsOutput)
}

func (i ConnectivityRuleTimeoutsArgs) ToConnectivityRuleTimeoutsPtrOutput() ConnectivityRuleTimeoutsPtrOutput {
	return i.ToConnectivityRuleTimeoutsPtrOutputWithContext(context.Background())
}

func (i ConnectivityRuleTimeoutsArgs) ToConnectivityRuleTimeoutsPtrOutputWithContext(ctx context.Context) ConnectivityRuleTimeoutsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ConnectivityRuleTimeoutsOutput).ToConnectivityRuleTimeoutsPtrOutputWithContext(ctx)
}

// ConnectivityRuleTimeoutsPtrInput is an input type that accepts ConnectivityRuleTimeoutsArgs, ConnectivityRuleTimeoutsPtr and ConnectivityRuleTimeoutsPtrOutput values.
// You can construct a concrete instance of `ConnectivityRuleTimeoutsPtrInput` via:
//
//	        ConnectivityRuleTimeoutsArgs{...}
//
//	or:
//
//	        nil
type ConnectivityRuleTimeoutsPtrInput interface {
	pulumi.Input

	ToConnectivityRuleTimeoutsPtrOutput() ConnectivityRuleTimeoutsPtrOutput
	ToConnectivityRuleTimeoutsPtrOutputWithContext(context.Context) ConnectivityRuleTimeoutsPtrOutput
}

type connectivityRuleTimeoutsPtrType ConnectivityRuleTimeoutsArgs

func ConnectivityRuleTimeoutsPtr(v *ConnectivityRuleTimeoutsArgs) ConnectivityRuleTimeoutsPtrInput {
	return (*connectivityRuleTimeoutsPtrType)(v)
}

func (*connectivityRuleTimeoutsPtrType) ElementType() reflect.Type {
	return reflect.TypeOf((**ConnectivityRuleTimeouts)(nil)).Elem()
}

func (i *connectivityRuleTimeoutsPtrType) ToConnectivityRuleTimeoutsPtrOutput() ConnectivityRuleTimeoutsPtrOutput {
	return i.ToConnectivityRuleTimeoutsPtrOutputWithContext(context.Background())
}

func (i *connectivityRuleTimeoutsPtrType) ToConnectivityRuleTimeoutsPtrOutputWithContext(ctx context.Context) ConnectivityRuleTimeoutsPtrOutput {
	return pulumi.ToOutputWithContext(ctx, i).(ConnectivityRuleTimeoutsPtrOutput)
}

type ConnectivityRuleTimeoutsOutput struct{ *pulumi.OutputState }

func (ConnectivityRuleTimeoutsOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*ConnectivityRuleTimeouts)(nil)).Elem()
}

func (o ConnectivityRuleTimeoutsOutput) ToConnectivityRuleTimeoutsOutput() ConnectivityRuleTimeoutsOutput {
	return o
}

func (o ConnectivityRuleTimeoutsOutput) ToConnectivityRuleTimeoutsOutputWithContext(ctx context.Context) ConnectivityRuleTimeoutsOutput {
	return o
}

func (o ConnectivityRuleTimeoutsOutput) ToConnectivityRuleTimeoutsPtrOutput() ConnectivityRuleTimeoutsPtrOutput {
	return o.ToConnectivityRuleTimeoutsPtrOutputWithContext(context.Background())
}

func (o ConnectivityRuleTimeoutsOutput) ToConnectivityRuleTimeoutsPtrOutputWithContext(ctx context.Context) ConnectivityRuleTimeoutsPtrOutput {
	return o.ApplyTWithContext(ctx, func(_ context.Context, v ConnectivityRuleTimeouts) *ConnectivityRuleTimeouts {
		return &v
	}).(ConnectivityRuleTimeoutsPtrOutput)
}

// A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
func (o ConnectivityRuleTimeoutsOutput) Create() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConnectivityRuleTimeouts) *string { return v.Create }).(pulumi.StringPtrOutput)
}

// A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
func (o ConnectivityRuleTimeoutsOutput) Delete() pulumi.StringPtrOutput {
	return o.ApplyT(func(v ConnectivityRuleTimeouts) *string { return v.Delete }).(pulumi.StringPtrOutput)
}

type ConnectivityRuleTimeoutsPtrOutput struct{ *pulumi.OutputState }

func (ConnectivityRuleTimeoutsPtrOutput) ElementType() reflect.Type {
	return reflect.TypeOf((**ConnectivityRuleTimeouts)(nil)).Elem()
}

func (o ConnectivityRuleTimeoutsPtrOutput) ToConnectivityRuleTimeoutsPtrOutput() ConnectivityRuleTimeoutsPtrOutput {
	return o
}

func (o ConnectivityRuleTimeoutsPtrOutput) ToConnectivityRuleTimeoutsPtrOutputWithContext(ctx context.Context) ConnectivityRuleTimeoutsPtrOutput {
	return o
}

func (o ConnectivityRuleTimeoutsPtrOutput) Elem() ConnectivityRuleTimeoutsOutput {
	return o.ApplyT(func(v *ConnectivityRuleTimeouts) ConnectivityRuleTimeouts {
		if v != nil {
			return *v
		}
		var ret ConnectivityRuleTimeouts
		return ret
	}).(ConnectivityRuleTimeoutsOutput)
}

// A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours).
func (o ConnectivityRuleTimeoutsPtrOutput) Create() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ConnectivityRuleTimeouts) *string {
		if v == nil {
			return nil
		}
		return v.Create
...
// A string that can be [parsed as a duration](https://pkg.go.dev/time#ParseDuration) consisting of numbers and unit suffixes, such as "30s" or "2h45m". Valid time units are "s" (seconds), "m" (minutes), "h" (hours). Setting a timeout for a Delete operation is only applicable if changes are saved into state before the destroy operation occurs.
func (o ConnectivityRuleTimeoutsPtrOutput) Delete() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *ConnectivityRuleTimeouts) *string {
		if v == nil {
			return nil
		}
...
type GroupAccessNamespaceAccess struct {
...
// GroupAccessNamespaceAccessInput is an input type that accepts GroupAccessNamespaceAccessArgs and GroupAccessNamespaceAccessOutput values.
// You can construct a concrete instance of `GroupAccessNamespaceAccessInput` via:
//
//	GroupAccessNamespaceAccessArgs{...}
type GroupAccessNamespaceAccessInput interface {
	pulumi.Input

	ToGroupAccessNamespaceAccessOutput() GroupAccessNamespaceAccessOutput
	ToGroupAccessNamespaceAccessOutputWithContext(context.Context) GroupAccessNamespaceAccessOutput
}

type GroupAccessNamespaceAccessArgs struct {
	// The namespace to assign permissions to.
...
func (GroupAccessNamespaceAccessArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GroupAccessNamespaceAccess)(nil)).Elem()
}

func (i GroupAccessNamespaceAccessArgs) ToGroupAccessNamespaceAccessOutput() GroupAccessNamespaceAccessOutput {
	return i.ToGroupAccessNamespaceAccessOutputWithContext(context.Background())
}

func (i GroupAccessNamespaceAccessArgs) ToGroupAccessNamespaceAccessOutputWithContext(ctx context.Context) GroupAccessNamespaceAccessOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GroupAccessNamespaceAccessOutput)
}

// GroupAccessNamespaceAccessArrayInput is an input type that accepts GroupAccessNamespaceAccessArray and GroupAccessNamespaceAccessArrayOutput values.
// You can construct a concrete instance of `GroupAccessNamespaceAccessArrayInput` via:
//
//	GroupAccessNamespaceAccessArray{ GroupAccessNamespaceAccessArgs{...} }
type GroupAccessNamespaceAccessArrayInput interface {
	pulumi.Input

	ToGroupAccessNamespaceAccessArrayOutput() GroupAccessNamespaceAccessArrayOutput
	ToGroupAccessNamespaceAccessArrayOutputWithContext(context.Context) GroupAccessNamespaceAccessArrayOutput
}

type GroupAccessNamespaceAccessArray []GroupAccessNamespaceAccessInput

func (GroupAccessNamespaceAccessArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GroupAccessNamespaceAccess)(nil)).Elem()
}

func (i GroupAccessNamespaceAccessArray) ToGroupAccessNamespaceAccessArrayOutput() GroupAccessNamespaceAccessArrayOutput {
	return i.ToGroupAccessNamespaceAccessArrayOutputWithContext(context.Background())
}

func (i GroupAccessNamespaceAccessArray) ToGroupAccessNamespaceAccessArrayOutputWithContext(ctx context.Context) GroupAccessNamespaceAccessArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GroupAccessNamespaceAccessArrayOutput)
}

type GroupAccessNamespaceAccessOutput struct{ *pulumi.OutputState }

func (GroupAccessNamespaceAccessOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GroupAccessNamespaceAccess)(nil)).Elem()
}

func (o GroupAccessNamespaceAccessOutput) ToGroupAccessNamespaceAccessOutput() GroupAccessNamespaceAccessOutput {
	return o
}

func (o GroupAccessNamespaceAccessOutput) ToGroupAccessNamespaceAccessOutputWithContext(ctx context.Context) GroupAccessNamespaceAccessOutput {
	return o
}

// The namespace to assign permissions to.
func (o GroupAccessNamespaceAccessOutput) NamespaceId() pulumi.StringOutput {
	return o.ApplyT(func(v GroupAccessNamespaceAccess) string { return v.NamespaceId }).(pulumi.StringOutput)
}

// The permission to assign. Must be one of admin, write, or read (case-insensitive)
func (o GroupAccessNamespaceAccessOutput) Permission() pulumi.StringOutput {
	return o.ApplyT(func(v GroupAccessNamespaceAccess) string { return v.Permission }).(pulumi.StringOutput)
}

type GroupAccessNamespaceAccessArrayOutput struct{ *pulumi.OutputState }

func (GroupAccessNamespaceAccessArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GroupAccessNamespaceAccess)(nil)).Elem()
}

func (o GroupAccessNamespaceAccessArrayOutput) ToGroupAccessNamespaceAccessArrayOutput() GroupAccessNamespaceAccessArrayOutput {
	return o
}

func (o GroupAccessNamespaceAccessArrayOutput) ToGroupAccessNamespaceAccessArrayOutputWithContext(ctx context.Context) GroupAccessNamespaceAccessArrayOutput {
	return o
}

func (o GroupAccessNamespaceAccessArrayOutput) Index(i pulumi.IntInput) GroupAccessNamespaceAccessOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GroupAccessNamespaceAccess {
		return vs[0].([]GroupAccessNamespaceAccess)[vs[1].(int)]
	}).(GroupAccessNamespaceAccessOutput)
}
...
// The GCP project ID associated with the GCS bucket and service account. If not provided, the service*account*email must be provided.
func (o NamespaceExportSinkGcsOutput) GcpProjectId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NamespaceExportSinkGcs) *string { return v.GcpProjectId }).(pulumi.StringPtrOutput)
}
...
// The service account email associated with the GCS bucket and service account. If not provided, the service*account*id and gcp*project*id must be provided.
func (o NamespaceExportSinkGcsOutput) ServiceAccountEmail() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NamespaceExportSinkGcs) *string { return v.ServiceAccountEmail }).(pulumi.StringPtrOutput)
}

// The customer service account ID that Temporal Cloud impersonates for writing records to the customer's GCS bucket. If not provided, the service*account*email must be provided.
func (o NamespaceExportSinkGcsOutput) ServiceAccountId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v NamespaceExportSinkGcs) *string { return v.ServiceAccountId }).(pulumi.StringPtrOutput)
}
...
// The service account email associated with the GCS bucket and service account. If not provided, the service*account*id and gcp*project*id must be provided.
func (o NamespaceExportSinkGcsPtrOutput) ServiceAccountEmail() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NamespaceExportSinkGcs) *string {
		if v == nil {
			return nil
		}
...
// The IDs of the connectivity rules for this namespace.
func (o GetNamespacesNamespaceOutput) ConnectivityRuleIds() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetNamespacesNamespace) []string { return v.ConnectivityRuleIds }).(pulumi.StringArrayOutput)
}
...
type GetNexusEndpointWorkerTarget struct {
...
// GetNexusEndpointWorkerTargetInput is an input type that accepts GetNexusEndpointWorkerTargetArgs and GetNexusEndpointWorkerTargetOutput values.
// You can construct a concrete instance of `GetNexusEndpointWorkerTargetInput` via:
//
//	GetNexusEndpointWorkerTargetArgs{...}
type GetNexusEndpointWorkerTargetInput interface {
	pulumi.Input

	ToGetNexusEndpointWorkerTargetOutput() GetNexusEndpointWorkerTargetOutput
	ToGetNexusEndpointWorkerTargetOutputWithContext(context.Context) GetNexusEndpointWorkerTargetOutput
}

type GetNexusEndpointWorkerTargetArgs struct {
	// The target cloud namespace to route requests to. Namespace is in same account as the endpoint.
	NamespaceId pulumi.StringInput `pulumi:"namespaceId"`
	// The task queue on the cloud namespace to route requests to.
	TaskQueue pulumi.StringInput `pulumi:"taskQueue"`
...
func (GetNexusEndpointWorkerTargetArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetNexusEndpointWorkerTarget)(nil)).Elem()
}

func (i GetNexusEndpointWorkerTargetArgs) ToGetNexusEndpointWorkerTargetOutput() GetNexusEndpointWorkerTargetOutput {
	return i.ToGetNexusEndpointWorkerTargetOutputWithContext(context.Background())
}

func (i GetNexusEndpointWorkerTargetArgs) ToGetNexusEndpointWorkerTargetOutputWithContext(ctx context.Context) GetNexusEndpointWorkerTargetOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetNexusEndpointWorkerTargetOutput)
}

type GetNexusEndpointWorkerTargetOutput struct{ *pulumi.OutputState }

func (GetNexusEndpointWorkerTargetOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetNexusEndpointWorkerTarget)(nil)).Elem()
}

func (o GetNexusEndpointWorkerTargetOutput) ToGetNexusEndpointWorkerTargetOutput() GetNexusEndpointWorkerTargetOutput {
	return o
}

func (o GetNexusEndpointWorkerTargetOutput) ToGetNexusEndpointWorkerTargetOutputWithContext(ctx context.Context) GetNexusEndpointWorkerTargetOutput {
	return o
}

// The target cloud namespace to route requests to. Namespace is in same account as the endpoint.
func (o GetNexusEndpointWorkerTargetOutput) NamespaceId() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointWorkerTarget) string { return v.NamespaceId }).(pulumi.StringOutput)
}

// The task queue on the cloud namespace to route requests to.
func (o GetNexusEndpointWorkerTargetOutput) TaskQueue() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointWorkerTarget) string { return v.TaskQueue }).(pulumi.StringOutput)
}

type GetNexusEndpointsNexusEndpoint struct {
	...
	WorkerTarget GetNexusEndpointsNexusEndpointWorkerTarget `pulumi:"workerTarget"`
}

// GetNexusEndpointsNexusEndpointInput is an input type that accepts GetNexusEndpointsNexusEndpointArgs and GetNexusEndpointsNexusEndpointOutput values.
// You can construct a concrete instance of `GetNexusEndpointsNexusEndpointInput` via:
//
//	GetNexusEndpointsNexusEndpointArgs{...}
type GetNexusEndpointsNexusEndpointInput interface {
	pulumi.Input

	ToGetNexusEndpointsNexusEndpointOutput() GetNexusEndpointsNexusEndpointOutput
	ToGetNexusEndpointsNexusEndpointOutputWithContext(context.Context) GetNexusEndpointsNexusEndpointOutput
}

type GetNexusEndpointsNexusEndpointArgs struct {
	// Namespace Id(s) that are allowed to call this Endpoint.
	AllowedCallerNamespaces pulumi.StringArrayInput `pulumi:"allowedCallerNamespaces"`
	// The creation time of the Nexus Endpoint.
	...
	// The target spec for routing nexus requests to a specific cloud namespace worker.
	WorkerTarget GetNexusEndpointsNexusEndpointWorkerTargetInput `pulumi:"workerTarget"`
}

func (GetNexusEndpointsNexusEndpointArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetNexusEndpointsNexusEndpoint)(nil)).Elem()
}

func (i GetNexusEndpointsNexusEndpointArgs) ToGetNexusEndpointsNexusEndpointOutput() GetNexusEndpointsNexusEndpointOutput {
	return i.ToGetNexusEndpointsNexusEndpointOutputWithContext(context.Background())
}

func (i GetNexusEndpointsNexusEndpointArgs) ToGetNexusEndpointsNexusEndpointOutputWithContext(ctx context.Context) GetNexusEndpointsNexusEndpointOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetNexusEndpointsNexusEndpointOutput)
}

// GetNexusEndpointsNexusEndpointArrayInput is an input type that accepts GetNexusEndpointsNexusEndpointArray and GetNexusEndpointsNexusEndpointArrayOutput values.
// You can construct a concrete instance of `GetNexusEndpointsNexusEndpointArrayInput` via:
//
//	GetNexusEndpointsNexusEndpointArray{ GetNexusEndpointsNexusEndpointArgs{...} }
type GetNexusEndpointsNexusEndpointArrayInput interface {
	pulumi.Input

	ToGetNexusEndpointsNexusEndpointArrayOutput() GetNexusEndpointsNexusEndpointArrayOutput
	ToGetNexusEndpointsNexusEndpointArrayOutputWithContext(context.Context) GetNexusEndpointsNexusEndpointArrayOutput
}

type GetNexusEndpointsNexusEndpointArray []GetNexusEndpointsNexusEndpointInput

func (GetNexusEndpointsNexusEndpointArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetNexusEndpointsNexusEndpoint)(nil)).Elem()
}

func (i GetNexusEndpointsNexusEndpointArray) ToGetNexusEndpointsNexusEndpointArrayOutput() GetNexusEndpointsNexusEndpointArrayOutput {
	return i.ToGetNexusEndpointsNexusEndpointArrayOutputWithContext(context.Background())
}

func (i GetNexusEndpointsNexusEndpointArray) ToGetNexusEndpointsNexusEndpointArrayOutputWithContext(ctx context.Context) GetNexusEndpointsNexusEndpointArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetNexusEndpointsNexusEndpointArrayOutput)
}

type GetNexusEndpointsNexusEndpointOutput struct{ *pulumi.OutputState }

func (GetNexusEndpointsNexusEndpointOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetNexusEndpointsNexusEndpoint)(nil)).Elem()
}

func (o GetNexusEndpointsNexusEndpointOutput) ToGetNexusEndpointsNexusEndpointOutput() GetNexusEndpointsNexusEndpointOutput {
	return o
}

func (o GetNexusEndpointsNexusEndpointOutput) ToGetNexusEndpointsNexusEndpointOutputWithContext(ctx context.Context) GetNexusEndpointsNexusEndpointOutput {
	return o
}

// Namespace Id(s) that are allowed to call this Endpoint.
func (o GetNexusEndpointsNexusEndpointOutput) AllowedCallerNamespaces() pulumi.StringArrayOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpoint) []string { return v.AllowedCallerNamespaces }).(pulumi.StringArrayOutput)
}

// The creation time of the Nexus Endpoint.
func (o GetNexusEndpointsNexusEndpointOutput) CreatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpoint) string { return v.CreatedAt }).(pulumi.StringOutput)
}

// The description of the Nexus Endpoint.
func (o GetNexusEndpointsNexusEndpointOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpoint) string { return v.Description }).(pulumi.StringOutput)
}

// The unique identifier of the Nexus Endpoint.
func (o GetNexusEndpointsNexusEndpointOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpoint) string { return v.Id }).(pulumi.StringOutput)
}

// The name of the endpoint. Unique within an account and match `^[a-zA-Z][a-zA-Z0-9\-]*[a-zA-Z0-9]$`
func (o GetNexusEndpointsNexusEndpointOutput) Name() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpoint) string { return v.Name }).(pulumi.StringOutput)
}

// The current state of the Nexus Endpoint.
func (o GetNexusEndpointsNexusEndpointOutput) State() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpoint) string { return v.State }).(pulumi.StringOutput)
}

// The last update time of the Nexus Endpoint.
func (o GetNexusEndpointsNexusEndpointOutput) UpdatedAt() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpoint) string { return v.UpdatedAt }).(pulumi.StringOutput)
}

// The target spec for routing nexus requests to a specific cloud namespace worker.
func (o GetNexusEndpointsNexusEndpointOutput) WorkerTarget() GetNexusEndpointsNexusEndpointWorkerTargetOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpoint) GetNexusEndpointsNexusEndpointWorkerTarget {
		return v.WorkerTarget
	}).(GetNexusEndpointsNexusEndpointWorkerTargetOutput)
}

type GetNexusEndpointsNexusEndpointArrayOutput struct{ *pulumi.OutputState }

func (GetNexusEndpointsNexusEndpointArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetNexusEndpointsNexusEndpoint)(nil)).Elem()
}

func (o GetNexusEndpointsNexusEndpointArrayOutput) ToGetNexusEndpointsNexusEndpointArrayOutput() GetNexusEndpointsNexusEndpointArrayOutput {
	return o
}

func (o GetNexusEndpointsNexusEndpointArrayOutput) ToGetNexusEndpointsNexusEndpointArrayOutputWithContext(ctx context.Context) GetNexusEndpointsNexusEndpointArrayOutput {
	return o
}

func (o GetNexusEndpointsNexusEndpointArrayOutput) Index(i pulumi.IntInput) GetNexusEndpointsNexusEndpointOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetNexusEndpointsNexusEndpoint {
		return vs[0].([]GetNexusEndpointsNexusEndpoint)[vs[1].(int)]
	}).(GetNexusEndpointsNexusEndpointOutput)
}

type GetNexusEndpointsNexusEndpointWorkerTarget struct {
	// The target cloud namespace to route requests to. Namespace is in same account as the endpoint.
	NamespaceId string `pulumi:"namespaceId"`
	// The task queue on the cloud namespace to route requests to.
	TaskQueue string `pulumi:"taskQueue"`
...
// GetNexusEndpointsNexusEndpointWorkerTargetInput is an input type that accepts GetNexusEndpointsNexusEndpointWorkerTargetArgs and GetNexusEndpointsNexusEndpointWorkerTargetOutput values.
// You can construct a concrete instance of `GetNexusEndpointsNexusEndpointWorkerTargetInput` via:
//
//	GetNexusEndpointsNexusEndpointWorkerTargetArgs{...}
type GetNexusEndpointsNexusEndpointWorkerTargetInput interface {
	pulumi.Input

	ToGetNexusEndpointsNexusEndpointWorkerTargetOutput() GetNexusEndpointsNexusEndpointWorkerTargetOutput
	ToGetNexusEndpointsNexusEndpointWorkerTargetOutputWithContext(context.Context) GetNexusEndpointsNexusEndpointWorkerTargetOutput
}

type GetNexusEndpointsNexusEndpointWorkerTargetArgs struct {
	// The target cloud namespace to route requests to. Namespace is in same account as the endpoint.
	NamespaceId pulumi.StringInput `pulumi:"namespaceId"`
	// The task queue on the cloud namespace to route requests to.
	TaskQueue pulumi.StringInput `pulumi:"taskQueue"`
...
func (GetNexusEndpointsNexusEndpointWorkerTargetArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetNexusEndpointsNexusEndpointWorkerTarget)(nil)).Elem()
}

func (i GetNexusEndpointsNexusEndpointWorkerTargetArgs) ToGetNexusEndpointsNexusEndpointWorkerTargetOutput() GetNexusEndpointsNexusEndpointWorkerTargetOutput {
	return i.ToGetNexusEndpointsNexusEndpointWorkerTargetOutputWithContext(context.Background())
}

func (i GetNexusEndpointsNexusEndpointWorkerTargetArgs) ToGetNexusEndpointsNexusEndpointWorkerTargetOutputWithContext(ctx context.Context) GetNexusEndpointsNexusEndpointWorkerTargetOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetNexusEndpointsNexusEndpointWorkerTargetOutput)
}

type GetNexusEndpointsNexusEndpointWorkerTargetOutput struct{ *pulumi.OutputState }

func (GetNexusEndpointsNexusEndpointWorkerTargetOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetNexusEndpointsNexusEndpointWorkerTarget)(nil)).Elem()
}

func (o GetNexusEndpointsNexusEndpointWorkerTargetOutput) ToGetNexusEndpointsNexusEndpointWorkerTargetOutput() GetNexusEndpointsNexusEndpointWorkerTargetOutput {
	return o
}

func (o GetNexusEndpointsNexusEndpointWorkerTargetOutput) ToGetNexusEndpointsNexusEndpointWorkerTargetOutputWithContext(ctx context.Context) GetNexusEndpointsNexusEndpointWorkerTargetOutput {
	return o
}

// The target cloud namespace to route requests to. Namespace is in same account as the endpoint.
func (o GetNexusEndpointsNexusEndpointWorkerTargetOutput) NamespaceId() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpointWorkerTarget) string { return v.NamespaceId }).(pulumi.StringOutput)
}

// The task queue on the cloud namespace to route requests to.
func (o GetNexusEndpointsNexusEndpointWorkerTargetOutput) TaskQueue() pulumi.StringOutput {
	return o.ApplyT(func(v GetNexusEndpointsNexusEndpointWorkerTarget) string { return v.TaskQueue }).(pulumi.StringOutput)
}
...
type GetUserNamespaceAccess struct {
	// The namespace to assign permissions to.
	NamespaceId string `pulumi:"namespaceId"`
	// The permission to assign. Must be one of admin, write, or read (case-insensitive)
	Permission string `pulumi:"permission"`
...
// GetUserNamespaceAccessInput is an input type that accepts GetUserNamespaceAccessArgs and GetUserNamespaceAccessOutput values.
// You can construct a concrete instance of `GetUserNamespaceAccessInput` via:
//
//	GetUserNamespaceAccessArgs{...}
type GetUserNamespaceAccessInput interface {
	pulumi.Input

	ToGetUserNamespaceAccessOutput() GetUserNamespaceAccessOutput
	ToGetUserNamespaceAccessOutputWithContext(context.Context) GetUserNamespaceAccessOutput
}

type GetUserNamespaceAccessArgs struct {
	// The namespace to assign permissions to.
	NamespaceId pulumi.StringInput `pulumi:"namespaceId"`
	// The permission to assign. Must be one of admin, write, or read (case-insensitive)
	Permission pulumi.StringInput `pulumi:"permission"`
...
func (GetUserNamespaceAccessArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetUserNamespaceAccess)(nil)).Elem()
}

func (i GetUserNamespaceAccessArgs) ToGetUserNamespaceAccessOutput() GetUserNamespaceAccessOutput {
	return i.ToGetUserNamespaceAccessOutputWithContext(context.Background())
}

func (i GetUserNamespaceAccessArgs) ToGetUserNamespaceAccessOutputWithContext(ctx context.Context) GetUserNamespaceAccessOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetUserNamespaceAccessOutput)
}

// GetUserNamespaceAccessArrayInput is an input type that accepts GetUserNamespaceAccessArray and GetUserNamespaceAccessArrayOutput values.
// You can construct a concrete instance of `GetUserNamespaceAccessArrayInput` via:
//
//	GetUserNamespaceAccessArray{ GetUserNamespaceAccessArgs{...} }
type GetUserNamespaceAccessArrayInput interface {
	pulumi.Input

	ToGetUserNamespaceAccessArrayOutput() GetUserNamespaceAccessArrayOutput
	ToGetUserNamespaceAccessArrayOutputWithContext(context.Context) GetUserNamespaceAccessArrayOutput
}

type GetUserNamespaceAccessArray []GetUserNamespaceAccessInput

func (GetUserNamespaceAccessArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetUserNamespaceAccess)(nil)).Elem()
}

func (i GetUserNamespaceAccessArray) ToGetUserNamespaceAccessArrayOutput() GetUserNamespaceAccessArrayOutput {
	return i.ToGetUserNamespaceAccessArrayOutputWithContext(context.Background())
}

func (i GetUserNamespaceAccessArray) ToGetUserNamespaceAccessArrayOutputWithContext(ctx context.Context) GetUserNamespaceAccessArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetUserNamespaceAccessArrayOutput)
}

type GetUserNamespaceAccessOutput struct{ *pulumi.OutputState }

func (GetUserNamespaceAccessOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetUserNamespaceAccess)(nil)).Elem()
}

func (o GetUserNamespaceAccessOutput) ToGetUserNamespaceAccessOutput() GetUserNamespaceAccessOutput {
	return o
}

func (o GetUserNamespaceAccessOutput) ToGetUserNamespaceAccessOutputWithContext(ctx context.Context) GetUserNamespaceAccessOutput {
	return o
}

// The namespace to assign permissions to.
func (o GetUserNamespaceAccessOutput) NamespaceId() pulumi.StringOutput {
	return o.ApplyT(func(v GetUserNamespaceAccess) string { return v.NamespaceId }).(pulumi.StringOutput)
}

// The permission to assign. Must be one of admin, write, or read (case-insensitive)
func (o GetUserNamespaceAccessOutput) Permission() pulumi.StringOutput {
	return o.ApplyT(func(v GetUserNamespaceAccess) string { return v.Permission }).(pulumi.StringOutput)
}

type GetUserNamespaceAccessArrayOutput struct{ *pulumi.OutputState }

func (GetUserNamespaceAccessArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetUserNamespaceAccess)(nil)).Elem()
}

func (o GetUserNamespaceAccessArrayOutput) ToGetUserNamespaceAccessArrayOutput() GetUserNamespaceAccessArrayOutput {
	return o
}

func (o GetUserNamespaceAccessArrayOutput) ToGetUserNamespaceAccessArrayOutputWithContext(ctx context.Context) GetUserNamespaceAccessArrayOutput {
	return o
}

func (o GetUserNamespaceAccessArrayOutput) Index(i pulumi.IntInput) GetUserNamespaceAccessOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetUserNamespaceAccess {
		return vs[0].([]GetUserNamespaceAccess)[vs[1].(int)]
	}).(GetUserNamespaceAccessOutput)
}
...
type GetUsersUser struct {
	...
	NamespaceAccesses []GetUsersUserNamespaceAccess `pulumi:"namespaceAccesses"`
...
type GetUsersUserArgs struct {
	...
	Id pulumi.StringInput `pulumi:"id"`
	// The set of namespace permissions for this user, including each namespace and its role.
	NamespaceAccesses GetUsersUserNamespaceAccessArrayInput `pulumi:"namespaceAccesses"`
	// The current state of the User.
	State pulumi.StringInput `pulumi:"state"`
	// The last update time of the User.
	UpdatedAt pulumi.StringInput `pulumi:"updatedAt"`
...
// The role on the account. Must be one of admin, developer, or read (case-insensitive).
func (o GetUsersUserOutput) AccountAccess() pulumi.StringOutput {
	return o.ApplyT(func(v GetUsersUser) string { return v.AccountAccess }).(pulumi.StringOutput)
}
...
// The set of namespace permissions for this user, including each namespace and its role.
func (o GetUsersUserOutput) NamespaceAccesses() GetUsersUserNamespaceAccessArrayOutput {
	return o.ApplyT(func(v GetUsersUser) []GetUsersUserNamespaceAccess { return v.NamespaceAccesses }).(GetUsersUserNamespaceAccessArrayOutput)
}
...
type GetUsersUserNamespaceAccess struct {
	// The namespace to assign permissions to.
	NamespaceId string `pulumi:"namespaceId"`
	// The permission to assign. Must be one of admin, write, or read (case-insensitive)
	Permission string `pulumi:"permission"`
...
// GetUsersUserNamespaceAccessInput is an input type that accepts GetUsersUserNamespaceAccessArgs and GetUsersUserNamespaceAccessOutput values.
// You can construct a concrete instance of `GetUsersUserNamespaceAccessInput` via:
//
//	GetUsersUserNamespaceAccessArgs{...}
type GetUsersUserNamespaceAccessInput interface {
	pulumi.Input

	ToGetUsersUserNamespaceAccessOutput() GetUsersUserNamespaceAccessOutput
	ToGetUsersUserNamespaceAccessOutputWithContext(context.Context) GetUsersUserNamespaceAccessOutput
}

type GetUsersUserNamespaceAccessArgs struct {
	// The namespace to assign permissions to.
	NamespaceId pulumi.StringInput `pulumi:"namespaceId"`
	// The permission to assign. Must be one of admin, write, or read (case-insensitive)
	Permission pulumi.StringInput `pulumi:"permission"`
...
func (GetUsersUserNamespaceAccessArgs) ElementType() reflect.Type {
	return reflect.TypeOf((*GetUsersUserNamespaceAccess)(nil)).Elem()
}

func (i GetUsersUserNamespaceAccessArgs) ToGetUsersUserNamespaceAccessOutput() GetUsersUserNamespaceAccessOutput {
	return i.ToGetUsersUserNamespaceAccessOutputWithContext(context.Background())
}

func (i GetUsersUserNamespaceAccessArgs) ToGetUsersUserNamespaceAccessOutputWithContext(ctx context.Context) GetUsersUserNamespaceAccessOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetUsersUserNamespaceAccessOutput)
}

// GetUsersUserNamespaceAccessArrayInput is an input type that accepts GetUsersUserNamespaceAccessArray and GetUsersUserNamespaceAccessArrayOutput values.
// You can construct a concrete instance of `GetUsersUserNamespaceAccessArrayInput` via:
//
//	GetUsersUserNamespaceAccessArray{ GetUsersUserNamespaceAccessArgs{...} }
type GetUsersUserNamespaceAccessArrayInput interface {
	pulumi.Input

	ToGetUsersUserNamespaceAccessArrayOutput() GetUsersUserNamespaceAccessArrayOutput
	ToGetUsersUserNamespaceAccessArrayOutputWithContext(context.Context) GetUsersUserNamespaceAccessArrayOutput
}

type GetUsersUserNamespaceAccessArray []GetUsersUserNamespaceAccessInput

func (GetUsersUserNamespaceAccessArray) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetUsersUserNamespaceAccess)(nil)).Elem()
}

func (i GetUsersUserNamespaceAccessArray) ToGetUsersUserNamespaceAccessArrayOutput() GetUsersUserNamespaceAccessArrayOutput {
	return i.ToGetUsersUserNamespaceAccessArrayOutputWithContext(context.Background())
}

func (i GetUsersUserNamespaceAccessArray) ToGetUsersUserNamespaceAccessArrayOutputWithContext(ctx context.Context) GetUsersUserNamespaceAccessArrayOutput {
	return pulumi.ToOutputWithContext(ctx, i).(GetUsersUserNamespaceAccessArrayOutput)
}

type GetUsersUserNamespaceAccessOutput struct{ *pulumi.OutputState }

func (GetUsersUserNamespaceAccessOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*GetUsersUserNamespaceAccess)(nil)).Elem()
}

func (o GetUsersUserNamespaceAccessOutput) ToGetUsersUserNamespaceAccessOutput() GetUsersUserNamespaceAccessOutput {
	return o
}

func (o GetUsersUserNamespaceAccessOutput) ToGetUsersUserNamespaceAccessOutputWithContext(ctx context.Context) GetUsersUserNamespaceAccessOutput {
	return o
}

// The namespace to assign permissions to.
func (o GetUsersUserNamespaceAccessOutput) NamespaceId() pulumi.StringOutput {
	return o.ApplyT(func(v GetUsersUserNamespaceAccess) string { return v.NamespaceId }).(pulumi.StringOutput)
}

// The permission to assign. Must be one of admin, write, or read (case-insensitive)
func (o GetUsersUserNamespaceAccessOutput) Permission() pulumi.StringOutput {
	return o.ApplyT(func(v GetUsersUserNamespaceAccess) string { return v.Permission }).(pulumi.StringOutput)
}

type GetUsersUserNamespaceAccessArrayOutput struct{ *pulumi.OutputState }

func (GetUsersUserNamespaceAccessArrayOutput) ElementType() reflect.Type {
	return reflect.TypeOf((*[]GetUsersUserNamespaceAccess)(nil)).Elem()
}

func (o GetUsersUserNamespaceAccessArrayOutput) ToGetUsersUserNamespaceAccessArrayOutput() GetUsersUserNamespaceAccessArrayOutput {
	return o
}

func (o GetUsersUserNamespaceAccessArrayOutput) ToGetUsersUserNamespaceAccessArrayOutputWithContext(ctx context.Context) GetUsersUserNamespaceAccessArrayOutput {
	return o
}

func (o GetUsersUserNamespaceAccessArrayOutput) Index(i pulumi.IntInput) GetUsersUserNamespaceAccessOutput {
	return pulumi.All(o, i).ApplyT(func(vs []interface{}) GetUsersUserNamespaceAccess {
		return vs[0].([]GetUsersUserNamespaceAccess)[vs[1].(int)]
	}).(GetUsersUserNamespaceAccessOutput)
}
...
func init() {
	...
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityRuleTimeoutsInput)(nil)).Elem(), ConnectivityRuleTimeoutsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*ConnectivityRuleTimeoutsPtrInput)(nil)).Elem(), ConnectivityRuleTimeoutsArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupAccessNamespaceAccessInput)(nil)).Elem(), GroupAccessNamespaceAccessArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GroupAccessNamespaceAccessArrayInput)(nil)).Elem(), GroupAccessNamespaceAccessArray{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetNexusEndpointWorkerTargetInput)(nil)).Elem(), GetNexusEndpointWorkerTargetArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetNexusEndpointsNexusEndpointInput)(nil)).Elem(), GetNexusEndpointsNexusEndpointArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetNexusEndpointsNexusEndpointArrayInput)(nil)).Elem(), GetNexusEndpointsNexusEndpointArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetNexusEndpointsNexusEndpointWorkerTargetInput)(nil)).Elem(), GetNexusEndpointsNexusEndpointWorkerTargetArgs{})
	...
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserNamespaceAccessInput)(nil)).Elem(), GetUserNamespaceAccessArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUserNamespaceAccessArrayInput)(nil)).Elem(), GetUserNamespaceAccessArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUsersUserInput)(nil)).Elem(), GetUsersUserArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUsersUserArrayInput)(nil)).Elem(), GetUsersUserArray{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUsersUserNamespaceAccessInput)(nil)).Elem(), GetUsersUserNamespaceAccessArgs{})
	pulumi.RegisterInputType(reflect.TypeOf((*GetUsersUserNamespaceAccessArrayInput)(nil)).Elem(), GetUsersUserNamespaceAccessArray{})
	pulumi.RegisterOutputType(ApikeyTimeoutsOutput{})
	pulumi.RegisterOutputType(ApikeyTimeoutsPtrOutput{})
	pulumi.RegisterOutputType(ConnectivityRuleTimeoutsOutput{})
	pulumi.RegisterOutputType(ConnectivityRuleTimeoutsPtrOutput{})
	pulumi.RegisterOutputType(GroupAccessNamespaceAccessOutput{})
	pulumi.RegisterOutputType(GroupAccessNamespaceAccessArrayOutput{})
	...
	pulumi.RegisterOutputType(GetNexusEndpointWorkerTargetOutput{})
	pulumi.RegisterOutputType(GetNexusEndpointsNexusEndpointOutput{})
	pulumi.RegisterOutputType(GetNexusEndpointsNexusEndpointArrayOutput{})
	pulumi.RegisterOutputType(GetNexusEndpointsNexusEndpointWorkerTargetOutput{})
	...
	pulumi.RegisterOutputType(GetUserNamespaceAccessOutput{})
	pulumi.RegisterOutputType(GetUserNamespaceAccessArrayOutput{})
	pulumi.RegisterOutputType(GetUsersUserOutput{})
	pulumi.RegisterOutputType(GetUsersUserArrayOutput{})
	pulumi.RegisterOutputType(GetUsersUserNamespaceAccessOutput{})
	pulumi.RegisterOutputType(GetUsersUserNamespaceAccessArrayOutput{})
}

...
namespace GripSecurity.PulumiTemporalCloud
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("GripSecurity.PulumiTemporalCloud.version.txt");
    ...
    internal sealed class PulumiTemporalCloudResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public PulumiTemporalCloudResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

...
namespace GripSecurity.Temporalcloud
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "https://github.com/Grip-Security/pulumi-temporalcloud/releases/download/v${VERSION}/";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("GripSecurity.Temporalcloud.version.txt");
    ...
    internal sealed class TemporalcloudResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public TemporalcloudResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

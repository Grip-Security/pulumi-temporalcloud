module github.com/Grip-Security/pulumi-temporalcloud/provider
...
require (
	...
	github.com/temporalio/terraform-provider-temporalcloud v0.9.0 // indirect
)
...
replace github.com/temporalio/terraform-provider-temporalcloud/shim => ./shim

require github.com/temporalio/terraform-provider-temporalcloud/shim v0.0.0
